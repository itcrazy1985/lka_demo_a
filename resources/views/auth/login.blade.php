                ...
                <div class="col-md-6 offset-md-3">
                    <div class="p-3 shadow bg-transparent border border-1 border-light rounded-4">
                        <div class="text-center mt-3">
                            <img src="{{ asset('/assets/img/main_logo.png') }}" alt=""
                        ...
                        <form action="{{ route('login') }}" method="post" class="p-5">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="user_name" id="login" class="form-control"
                            ...
                            <div class="mb-3">
                                <div class="input-group border border-1">
                                    <span class="input-group-text bg-white border border-0"><i
                                            class="fas fa-key text-purple"></i></span>
                                    <input type="password" name="password" id="password"
                                        class="form-control border border-0" placeholder="လျှို့ဝှက်နံပါတ်ထည့်ပါ">
                                    <span class="input-group-text bg-white border border-0"><i
                                            class="fas fa-eye text-purple" id="eye" onclick="PwdView()"
